...
void mtk_prepare_venc_emi_bw(struct mtk_vcodec_dev *dev)
{
	...
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l19_venc_sub_r_chroma");

	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_rcpu");/*17*/
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_rec");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_bsdma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_sv_comv");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_rd_comv");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_nbm_rdma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_nbm_rdma_lite");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_sub_w_luma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_fcs_nbm_rdma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_nbm_wdma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_nbm_wdma_lite");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_fcs_nbm_wdma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_cur_luma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_cur_chroma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_ref_luma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_ref_chroma");
	dev->venc_qos_req[i++] = of_mtk_icc_get(&pdev->dev, "l20_venc_sub_r_chroma");
