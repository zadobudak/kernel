...
void clean_irq_status(unsigned int irq_status, void __iomem *addr)
{
	...
	if (irq_status & MTK_VENC_IRQ_STATUS_SLICE)
		writel(MTK_VENC_IRQ_STATUS_SLICE, addr);
...
void mtk_vcodec_enc_timeout_dump(void *ctx)
{
	...
	#define REG1_COUNT 28
	#define REG2_COUNT 46

	unsigned int Reg_1[REG1_COUNT] = {
		0x14, 0x24, 0x98, 0xEC, 0x1C0,
		0xF4, 0x5C, 0x60, 0x130, 0x114C,
		0x1164, 0x1168, 0x114C, 0x11C0, 0x11C4,
		0x1164,0x11C0, 0x11C4, 0x1030, 0x12D0,
		0x1228, 0x1380, 0x1384, 0x1388, 0x138C,
		0x1398, 0x1330, 0x1334};
	...
	unsigned int Reg_2[REG2_COUNT] = {
		...
		0x280, 0x22C, 0x230, 0xF4,
		0x1168,0x11C0, 0x11C4, 0x1030,
		0x240, 0x248, 0x250, 0x130, 0x140};
