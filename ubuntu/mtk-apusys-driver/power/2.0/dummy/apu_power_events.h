...
TRACE_EVENT(APUSYS_DFS,
	...
	TP_fast_assign(
		...
		__entry->mdla1_freq = pwr_info->mdla1_freq;
		__entry->ipuif_freq = pwr_info->ipuif_freq;
	),
	TP_printk("conn=%d,vpu0=%d,vpu1=%d,mdla0=%d,mdla1=%d,ipuif=%d",
		__entry->conn_freq, __entry->vpu0_freq,
		__entry->vpu1_freq, __entry->mdla0_freq,
		__entry->mdla1_freq, __entry->ipuif_freq)
);
