...
#define OTHER_PWR_STATUS	((void *)(APU_SPM_BASE + 0x198))
#define BUCK_ISOLATION		((void *)(APU_SPM_BASE + 0x3EC))
...
#define APU_MDLA1_APU_MDLA_CG_CLR	((void *)(APU_MDLA1_BASE + 0x008))
